...
class ObjectsInRedis {
    ...
    _delBinaryState(id, callback) {
        if (!this.client) {
            typeof callback === 'function' && callback(utils.ERRORS.ERROR_DB_CLOSED);
        } else {
            ...
            this.client.mget(_keys, (err, objs) => {
                ...
                if (objs) {
                    for (let r = 0; r < objs.length; r++) {
                        ...
                        if (!objs[r] || !utils.checkObject(objs[r], options, utils.CONSTS.ACCESS_READ)) continue;
    ...
    extendObject(id, obj, options, callback) {
        ...
        if (!callback) {
            return new Promise((resolve, reject) =>
                this.extendObject(id, obj, options, (err, obj) => err ? reject(err) : resolve(obj)));
        }
